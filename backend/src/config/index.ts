...
const envSchema = z.object({
  ...
  FIELD_ENCRYPTION_KEY: z.string().min(16).default('0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef'),
  PHONE_HASH_KEY: z.string().min(16).default('fedcba9876543210fedcba9876543210fedcba9876543210fedcba9876543210'),
